'''
Evaluate MLP w/ meta-learning domain generalization. Should be
...
from ad_models import MetaLearningModel, MetaLearningModelBayesian
...
if __name__ == '__main__':
    ...
    for strHpoDir in lsHpoDirs:
        ...
        if args.bayesian:
            model = MetaLearningModelBayesian(dictBestConfig, strFoldOutputDir)
        else:
            model = MetaLearningModel(dictBestConfig, strFoldOutputDir)

...
RESULTSDIR = '/archive/bioinformatics/DLLab/KevinNguyen/results/MEDL/gbm_segmentation_randomint1024_20210106'
SEED = 9786
...
def train(fold, augment=True):
    ...
    model = unet.unet_mixedeffects((nGroups,), input_size=tupImgShape, random_int=True)
